...
<script type="text/html" id="dxrp-editing-field-datetime">
    <div style="width: 100%" class="dxrp-editing-field-datetime" data-bind="dxDateBox: $data.getOptions({ dropDownOptions: { container: $root.getPopupContainer($element) } }), childStyle: { style: textStyle(), selector: '.dx-texteditor-input'}"></div>
</script>
...
<script type="text/html" id="dxrp-editing-field-checkbox">
    <div class="dxrp-editing-field-check-container" data-bind="style: containerStyle(), zoom: zoom, click: onClick">
        <div class="dxrp-editing-field-check" data-bind="style: checkStyle(), template: {name: $data.checkStateStyleIcon, if: !!ko.unwrap($data.checkStateStyleIcon)}"> </div>
    </div>
</script>
...
<script type="text/html" id="dxrd-page-brick">
    <div class="dxrd-report-preview-brick" data-bind="dxclick: function(_, event){ onClick(event); }, style: { top: topP, left: $data.leftP, right: $data.rightP, height: heightP, width: widthP }, css: { 'dxrd-report-preview-brick-selected': $data.active, 'dxrd-report-preview-brick-selectable': !($data.bricks) }">
...
<script type="text/html" id="dxcd-viewHeader">
    <div data-bind="dxSelectBox: { dataSource: values, itemTemplate: 'stateItem', valueExpr: 'value', value: generateHeaderValue($root.undoEngine), displayExpr: 'displayValue', disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }">
...
<script type="text/html" id="dxrd-richtext-loadfile">
    <div data-bind="dxFileImagePicker: { value: value, format: format, useFormat: true, placeholderId: 'File', disabled: disabled, accept:'.rtf,.docx,.txt,.htm,.html' }"></div>
</script>
